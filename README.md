<div align="center">
  ...
  <p>
    <strong>Computer Engineering</strong> student at URJC and passionate developer interested in technology, <strong>Blockchain</strong> ecosystem and creating solutions to complex problems. Always looking to learn and build new things.
  </p>
</div>
    ...
    <tr>
      <td width="50%" align="center" style="vertical-align: top; padding: 10px;">
        <div style="height: 220px; display: flex; flex-direction: column; justify-content: space-between;">
          ...
          <br>
          <p><strong>🎫 Ticket Sales Platform with Spring Boot</strong></p>
        </div>
      </td>
      <td width="50%" align="center" style="vertical-align: top; padding: 10px;">
        <div style="height: 220px; display: flex; flex-direction: column; justify-content: space-between;">
          ...
          <br>
          <p><strong>⚡ Minecraft Mod Updater in Python</strong></p>
        </div>
      </td>
    </tr>
  </table>
